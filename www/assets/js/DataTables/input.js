   ...
   (function ($) {
       ...
       $.fn.dataTableExt.oPagination.input = {
           'fnInit': function (oSettings, nPaging, fnCallbackDraw) {
               var buttonWrapper = document.createElement('ul');
               ...
               var infoWrapper = document.createElement('li');
               ...
               infoWrapper.innerHTML = "<span style='height:34px;' class='paginate_button center'></span>"; 
   
               nFirst.className = firstClassName + ' ' + classes.sPageButton;
               nPrevious.className = previousClassName + ' ' + classes.sPageButton;
               nNext.className = nextClassName + ' ' + classes.sPageButton;
               nLast.className = lastClassName + ' ' + classes.sPageButton;
               infoWrapper.className = classes.sPageButton;
               ...
               nInput.type = 'text';
               nPage.innerHTML = 'Страница ';
               nPaging.appendChild(buttonWrapper);
               buttonWrapper.appendChild(nFirst);
               buttonWrapper.appendChild(nPrevious);
               infoWrapper.firstChild.appendChild(nPage);
               
               infoWrapper.firstChild.appendChild(nInput);
               infoWrapper.firstChild.appendChild(nOf);

               buttonWrapper.appendChild(infoWrapper);
               buttonWrapper.appendChild(nNext);
               buttonWrapper.appendChild(nLast);
               ...
               $('span span', nPaging).bind('mousedown', function () { return false; });
               $('span span', nPaging).bind('selectstart', function() { return false; });
           ...
           'fnUpdate': function (oSettings) {
               ...
               $(an).find('.' + paginateOfClassName).html(' из ' + iPages);
